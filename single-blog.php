                  ...
                  <div class="cart-dropdown header-link-dropdown">
                    <ul class="cart-list link-dropdown-list">
                      <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                        <div class="media"> <a class="pull-left"> <img alt="Eshoper" src="http://aaryaweb.info/html/eshoper/esh001/images/1.jpg"></a>
                      ...
                      <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                        <div class="media"> <a class="pull-left"> <img alt="Eshoper" src="http://aaryaweb.info/html/eshoper/esh001/images/2.jpg"></a>
                          <div class="media-body"> <span><a>Black African Print Skirt</a></span>
                            <p class="cart-price">$14.99</p>
                            <div class="product-qty">
                              <label>Qty:</label>
                    ...
                    <div class="megamenu mobile-sub-menu">
                      <div class="megamenu-inner-top">
                        ...
                        <div class="megamenu-inner-bottom mt-20 visible-lg visible-md">
                          <a href="shop.html">
                            <img src="images/drop_banner.jpg" alt="Eshoper">
                          </a>
                      </div>
                    </div>
                  </li>
              ...
              <div class="comments-area-main">
                <div class="comments-area">
                  ...
                  <ul class="comment-list mt-30">
                    <li>
                      <div class="comment-user"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/comment-user.jpg" alt="Eshoper"> </div>
