...
if(isset($_POST['adminLogin'])){
  ...
  if($number==1){
    $_SESSION['admin_username'] = $recSet['username'];
...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300,italic,400italic,600italic">
</head>
