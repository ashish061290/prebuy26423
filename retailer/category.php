...
?>            
 ...
 $DeActivateQuery = "UPDATE `category` SET `category_status`=0 WHERE `category_id`='".$id."' ";
...
$ActivateQuery = "UPDATE `category` SET `category_status`=1 WHERE `category_id`=$id";
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
<?php
$fetch_seller = "SELECT * FROM 	`category` ";
                ...
                <tr>
                  ...
                  <td>
                   ...
                   <?php if($row['category_status']==0)
                      {?>
                    <a href="category.php?action=activate&id=<?=$row['category_id']?>"><button class='btn btn-info'>Activate</button></a>
                    <?php  }
                    elseif ($row['category_status']==1) { ?>
                    <a href="category.php?action=deactivate&id=<?=$row['category_id']?>"><button class='btn btn-warning'>DeActivate</button></a>
                    <?php  } 
                    ?>
                  </td>
                </tr>
