...
if(isset($_POST['submit'])){
   ...
   <div class="alert alert-success alert-dismissible">
    ...
    <?php } else{ ?>
        ...
        <div class="box-footer">
          Visit <a href="https://sathitech.com">Sathitech</a> for more examples and information about
          the plugin.
        </div></div> <?php } }
  //add form end
     else if($action=="deactivate"){
     $Deactive = $Base->ActiveDeactive($id,$status,'category');
     if($Deactive){
    ?>
              <div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true" onclick="window.location='category.php'">&times;</button>
 ...
 $active = $Base->ActiveDeactive($id,$status,'category');
 if($active){
    ?>
              <div class="alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true" onclick="window.location='category.php'">&times;</button>
