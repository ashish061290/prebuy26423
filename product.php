...
<link rel="shortcut icon" href="http://aaryaweb.info/html/eshoper/esh001/images/favicon.png">
<link rel="apple-touch-icon" href="http://aaryaweb.info/html/eshoper/esh001/images/apple-touch-icon.png">
<link rel="apple-touch-icon" sizes="72x72" href="http://aaryaweb.info/html/eshoper/esh001/images/apple-touch-icon-72x72.png">
<link rel="apple-touch-icon" sizes="114x114" href="http://aaryaweb.info/html/eshoper/esh001/images/apple-touch-icon-114x114.png">
</head>
<body >
      ...
      <div class="header-inner">
        <div class="row">
          <div class="col-md-3 col-xs-6">
            <div class="navbar-header"> <a class="navbar-brand page-scroll" href="index.html"> <img alt="Eshoper" src="http://aaryaweb.info/html/eshoper/esh001/images/logo.png"> </a> </div>
          </div>
                  ...
                  <div class="cart-dropdown header-link-dropdown">
                    <ul class="cart-list link-dropdown-list">
                      <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                        <div class="media"> <a class="pull-left"> <img alt="Eshoper" src="images/1.jpg"></a>
                      ...
                      <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                        <div class="media"> <a class="pull-left"> <img alt="Eshoper" src="images/2.jpg"></a>
                          <div class="media-body"> <span><a>Black African Print Skirt</a></span>
                            <p class="cart-price">$14.99</p>
                            <div class="product-qty">
                              <label>Qty:</label>
                    ...
                    <div class="megamenu mobile-sub-menu">
                      <div class="megamenu-inner-top">
                        ...
                        <div class="megamenu-inner-bottom mt-20 visible-lg visible-md">
                          <a href="shop.html">
                            <img src="http://aaryaweb.info/html/eshoper/esh001/images/drop_banner.jpg" alt="Eshoper">
                          </a>
                      </div>
                    </div>
                  </li>
                                ...
                                <div class="row">
                                  <div class="col-md-6 visible-lg visible-md mt-30">
                                    <div class="sub-menu-img">
                                      <a href="shop.html"> 
                                        <img src="http://aaryaweb.info/html/eshoper/esh001/images/drop_banner1.jpg" alt="Eshoper"> 
                                      </a>
                                    </div>
                                  </div>
                                  <div class="col-md-6 visible-lg visible-md mt-30">
                                    <div class="sub-menu-img">
                                      <a href="shop.html"> 
                                        <img src="http://aaryaweb.info/html/eshoper/esh001/images/drop_banner2.jpg" alt="Eshoper"> 
                                      </a>
                                    </div>
                                  </div>
                                </div>
                                      ...
                                      <div class="owl-carousel sub_menu_slider">
                                        <div class="product-item">
                                          <div class="product-image"> 
                                            <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/1.jpg" alt="Eshoper"> </a>
                                          </div>
                                        ...
                                        <div class="product-item">
                                          <div class="product-image"> 
                                            <a href="product-page.html"> <img src="images/2.jpg" alt="Eshoper"> </a>
                                          </div>
                                          <div class="product-item-details">
                                            <div class="product-item-name"> <a href="http://aaryaweb.info/html/eshoper/esh001/product-page.html">Defyant Reversible Dot Shorts</a> </div>
                                            <div class="price-box"> <span class="price">$80.00</span> 
                                              <!-- <del class="price old-price">$100.00</del>-->              
                                            </div>
                                            <div class="rating-summary-block right-side">
                                        ...
                                        <div class="product-item">
                                          <div class="product-image"> 
                                            <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/3.jpg" alt="Eshoper"> </a>
                                          </div>
                                          <div class="product-item-details">
                                            <div class="product-item-name"> <a href="product-page.html">Defyant Reversible Dot Shorts</a> </div>
                                            <div class="price-box"> <span class="price">$80.00</span> 
                                        ...
                                        <div class="product-item">
                                          <div class="product-image"> 
                                            <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/4.jpg" alt="Eshoper"> </a>                  
                                          </div>
                                          <div class="product-item-details">
                                            <div class="product-item-name"> <a href="product-page.html">Defyant Reversible Dot Shorts</a> </div>
                                            <div class="price-box"> <span class="price">$80.00</span> 
                                        ...
                                        <div class="product-item">
                                          <div class="product-image"> 
                                            <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/5.jpg" alt="Eshoper"> </a>
                                          </div>
                                          <div class="product-item-details">
                                            <div class="product-item-name"> <a href="product-page.html">Defyant Reversible Dot Shorts</a> </div>
                                            <div class="price-box"> <span class="price">$80.00</span> 
      ...
      <div class="row">
        <div class="col-lg-2 col-md-3 mb-sm-30 sidebar-col">
          <div class="sidebar-block">
            ...
            <div class="sidebar-box mb-40 visible-md visible-lg"> 
              <a href="#"> 
                <img src="images/left-banner.jpg" alt="Eshoper"> 
              </a> 
            </div>
            <div class="sidebar-box sidebar-item"> <span class="opener plus"></span>
              ...
              <div class="sidebar-contant">
                <ul>
                  <li>
                    <div class="pro-media"> <a><img alt="T-shirt" src="http://aaryaweb.info/html/eshoper/esh001/images/1.jpg"></a> </div>
        ...
        <div class="col-lg-10 col-md-9 content-col">
          <div class="inner-banner2 mb-40 visible-md visible-lg">
            <a href="shop.html">
              <img src="images/inner-banner2.jpg" alt="Eshoper">
            </a>
          </div> 
            ...
            <div class="inner-listing">
              <div class="row mlr_-20">
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/1.jpg" alt=""> </a>
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    ...
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/2.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    ...
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/14.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/3.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/13.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/15.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/4.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/5.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="new-label"><span>New</span></div>
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/8.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="new-label"><span>New</span></div>
                    <div class="sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/16.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/7.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/12.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.html"> <img src="http://aaryaweb.info/html/eshoper/esh001/images/9.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
