...
if($uploadFile){
  ...
  echo $categoryQuery = "INSERT INTO `brands`(`brand_name`,`brand_logo`) VALUES ('".$category_name."','http://".$_SERVER['HTTP_HOST'].'/uploads/'.$category_file."')"; 
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <input type="file" name="brand_logo"  class="form-control" accept="image/*" required="true">
              </div>
           
              <!-- /.form-group -->
                            <div class="form-group">
             <input type="submit" class="btn btn-success" name="submit" value="Update Brand">
            </div>
          </div>   
                 </form></div></div></div>
            <!-- /.col -->
<?php
if(isset($_POST['submit'])){
  $category_name = mysqli_real_escape_string($conn,$_POST['brand_name']);
  $category_tmp_file = $_FILES['brand_logo']['tmp_name'];
  $category_file = $_FILES['brand_logo']['name'];
  $path = "../uploads/";

$uploadFile = move_uploaded_file($category_tmp_file,$path.$category_file);
if($uploadFile){

   $updateQuery = "UPDATE `brands` SET `brand_name`='".$category_name."',`brand_logo`='http://".$_SERVER['HTTP_HOST'].'/uploads/'.$category_file."' WHERE `brand_id` = $id";
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
<?php
$fetch_seller = "SELECT * FROM 	`brands` ";
