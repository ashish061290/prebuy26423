...
<div class="box box-default">
        ...
        <?php
if($getdeals['deal_status']==1){ echo "<span class='pull-right badge bg-green'>Active</span>";}
...
<img src="http://prebuy.brijendrasharma.com/products/<?=$getProduct['product_img']?>" style="width:100px;">
  </td>
</tr>
...
<tr><th>Deal Exchange</th><td><?=$getdeals['deal_exchange']?></td></tr>                  
  ...
  $update = $Base->SaveEdit(array("deal_status"=>1),$id,'deal_id','prebuy_deals');
if($update){
  ?>
 <div class="col-sm-12 alert alert-success alert-dismissible">
  ...
  $update = $Base->SaveEdit(array("deal_status"=>2),$id,'deal_id','prebuy_deals');
if($update){ ?>
 <div class="col-sm-12 alert alert-success alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true" onclick="window.location='dealApproval.php'">&times;</button>
                <h4><i class="icon fa fa-check"></i> Success!</h4>
...
<!--            <a href="category.php?action=add"><button class="btn btn-danger">Add New Category</button></a>-->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
               // $condition = "dealOwnerId='".$retailers['o_seller_id']."' && deal_status=0";
               $condition = "dealOwnerId='".$retailers['o_seller_id']."' && deal_status=0";
                ...
                <tr>
                  ...
                  <td><img src="<?=$row['deal_offer_image']?>" style='width:50px;'>
                  </td>
                  <td>
