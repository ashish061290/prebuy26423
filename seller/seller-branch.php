        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header bg-light-blue">
              <h3 class="box-title"><?=$sellerDetail['o_seller_store']?> Branch 1</h3>
            </div>
            <div class="box-body">
<?php
...
?>
 ...
 <div class="col-sm-12 alert alert-success alert-dismissible" id="seller-success" style="z-index: 1;position:absolute;margin-top:-1000px;">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true" onclick="window.location='#'">&times;</button>
...
<div class="box">
            <div class="box-header bg-light-blue">
              <h3 class="box-title"><?=$sellerDetail['o_seller_store']?>, Branch 2</h3>
            </div>
            <div class="box-body">
<?php
...
<button type="submit" name="seller_branch2" class="btn btn-success">Add Branch</button>
</div>
</form>
<?php
