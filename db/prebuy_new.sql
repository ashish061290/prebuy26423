...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2023 at 05:25 PM
...
(11, 'DL18ID11', 7, 'Samsung Galaxy On Nx', 15000, 13333, '11.113333333333333', 'tab1.jpeg', 'extra discount in master card', 'get 20% discount by using sbi card', 'sssss', 'fffffffffffffffffffffffff', 'dddddddddddddv  dd', 2, '0000-00-00 00:00:00', '', 1),
...
INSERT INTO `users` (`user_id`, `username`, `loginuser`, `usermobile`, `mobile_verify`, `useremail`, `mail_verify`, `userpwd`, `token`, `user_status`, `user_type`, `created_at`, `otp`) VALUES
(2, 'Brijendra Sharma', '', 9165942918, 0, 'brijendra.mastery@gmail.com', 0, 'brij@789', '95629', 0, 0, '', ''),
(3, 'prashant1990', '', 9990482885, 0, 'prashantabhi26@gmail.com', 0, '9990482885', '52402', 0, 0, '', ''),
(4, 'rishi', '', 9584144994, 0, 'shubhamshrivastava21@gmail.com', 0, '95841444994', '33815', 1, 0, '', ''),
(5, 'sonali', '', 1234567890, 0, 'sonalij859@gmail.com', 0, '1234', '72746', 1, 0, '', ''),
(6, 'admin', 'USER-6', 9098561706, 0, 'ashish.tech1010@gmail.com', 0, 'e6e061838856bf47e1de', '11feba4a87fcae72816eeae1e7bfcae4', 0, 0, '2023-05-02 14:58:24', '3623');
...
CREATE TABLE `users_deals` (
  `u_deal_id` int(11) NOT NULL,
  `u_pre_deal_id` int(11) NOT NULL,
  `ticketno` int(11) NOT NULL,
  `dealpdf` int(11) NOT NULL,
  `deal_exp_status` int(11) NOT NULL,
