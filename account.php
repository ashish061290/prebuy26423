...
<?php   include "includes/head.php";
        ...
        if(!isset($_SESSION['userid'])){
          ...
          $user = $Base->SelectData('users','user_id',$_SESSION['userid']);
        } ?>
<body>
            ...
            <div class="account-tab-inner">
              <ul class="account-tab-stap">
                ...
                <form method="GET" action="">
                    <input type="submit" name="logout" value="Logout" class="btn btn-danger btn-flat" />
                  </form> </li>
          ...
          <div id="data-step1" class="account-content" data-temp="tabdata">
            ...
            <div class="mb-30">
              <div class="row">
                <div class="col-xs-12">
                  <div class="heading-part">
                    <h3 class="sub-heading">Hello, <?=$user['username']?></h3>
                  </div>
                  <?php if($user['mail_verify']==0){ ?>
                  <p>Email Address Is Not Verify Please Verify Your Email Address.<a class="account-link" id="subscribelink" href="#">Click Here</a></p>
                   <?php } ?>
                </div>
              </div>
            </div>
            <div class="m-0">
              <div class="row">
                <div class="col-xs-12 mb-20">
                  <div class="heading-part">
                    <h3 class="sub-heading">My Deal/Offer Information</h3>
                  </div>
                  <hr>
                </div>
                <div class="row">
                      ...
                      <tbody>
                        <tr>
                          <td><a href="product-page.html">
                            <div class="product-image"><img alt="Eshoper" src="http://aaryaweb.info/html/eshoper/esh001/images/1.jpg"></div>
                            </a></td>
                        ...
                        <tr>
                          <td><a href="product-page.html">
                            <div class="product-image"><img alt="Eshoper" src="http://aaryaweb.info/html/eshoper/esh001/images/2.jpg"></div>
                            </a></td>
